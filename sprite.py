...
class Meteorite(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("метеорит.png")
...
class Mouse_starship(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("звездолёт.png")
        size = random.randint(70, 150)
...
class Starship(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("звездолёт повёрнутый.png")
...
class Captain(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("капитан.png")
...
class Alien(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("инопланетянин.png")
        self.image = pg.transform.scale(self.image, (400, 400))
